...
let g:terminal_ansi_colors = [ s:surface1,s:red,s:green,s:yellow,s:blue,s:pink,s:teal,s:subtext1,s:surface2,s:red,s:green,s:yellow,s:blue,s:pink,s:teal,s:subtext0 ]
